...
export default function Checkbox(props) {
  ...
  return (
    <label
      className={`flex justify-between border border-solid py-1 font px-2 max-h-[34px] rounded border-rose-500 cursor-pointer only-after:bg-[#ff4f6b] hover:bg-red-50 ${isChecked ? "bg-rose-500 text-white  hover:bg-rose-600" : "text-rose-500"}`}
      htmlFor={props.label}>
      {props.label}
